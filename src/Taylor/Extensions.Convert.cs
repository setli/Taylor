...
namespace Taylor
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return Taylor.Helpers.Convert.ToBool(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToBoolOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToInt(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToIntOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToLong(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToLongOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDouble(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDoubleOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDecimal(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDecimalOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDate(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToDateOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToGuid(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToGuidOrNull(obj);
        }
        ...
        {
            return Taylor.Helpers.Convert.ToGuidList(obj);
        }
