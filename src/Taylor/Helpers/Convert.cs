...
namespace Taylor.Helpers
{
    ...
    public static class Convert
    {
        ...
        /// <returns></returns>
        public static double ToFloat(object input, int? digits = null)
        {
        ...
        /// <param name="digits">小数位数</param>
        /// <returns></returns>
        public static double? ToFloatOrNull(object input, int? digits = null)
        {
            float result;
